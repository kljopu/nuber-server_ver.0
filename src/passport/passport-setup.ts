        ...
        new LocalStrategy.Strategy({
            ...
            try {
                ...
                if (user) {
                    ...
                    newUser.profilePhoto = req.body.profilePhoto !== null ? req.body.profilePhoto : process.env.S3_URL + "default-avatar.png"
                    newUser.emailVerificationCode = Math.floor(Math.random() * 1000000)
                    newUser.phonelVerificationCode = Math.floor(Math.random() * 1000000)
                    await newUser.save()
                    console.log("saved");
                    done(null, newUser)
                }
